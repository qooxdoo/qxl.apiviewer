 ...
 */
qx.Class.define("qx.app.apiviewer.Viewer",
{
  ...
  */
  construct : function()
  {
    ...
    var tree = new qx.app.apiviewer.ui.PackageTree();
    tree.setId("tree");

    this._searchView = new qx.app.apiviewer.ui.SearchView();

    var legend = new qx.app.apiviewer.ui.LegendView();
  ...
  members :
  {
   ...
   /**
    ...
    __createToolbar : function()
    {
      ...
      var expandBtn = new qx.ui.toolbar.CheckBox(this.tr("Properties"), "qx/app/apiviewer/image/property18.gif");
      ...
      var includesBtn = new qx.ui.toolbar.MenuButton(this.tr("Includes"), "qx/app/apiviewer/image/overlay_mixin18.gif");
      ...
      var protectedBtn = new qx.ui.toolbar.CheckBox(this.tr("Protected"), "qx/app/apiviewer/image/method_protected18.gif");
      ...
      var privateBtn = new qx.ui.toolbar.CheckBox(this.tr("Private"), "qx/app/apiviewer/image/method_private18.gif");
      privateBtn.setId("btn_private");
      privateBtn.setToolTipText(this.tr("Show/hide private members of the current class."));
      part.add(privateBtn);

      var internalBtn = new qx.ui.toolbar.CheckBox(this.tr("Internal"), "qx/app/apiviewer/image/method_internal18.gif");
    ...
    __createDetailFrame : function()
    {
      ...
      this._tabView = new qx.app.apiviewer.DetailFrameTabView();
    ...
    __createHeader : function()
    {
      ...
      var version = new qx.app.apiviewer.VersionLabel();
  ...
  */
  ...
  environment :
  {
    "qx.app.apiviewer.title"            : "qooxdoo",
    "qx.app.apiviewer.initialTreeDepth" : 1
  },
