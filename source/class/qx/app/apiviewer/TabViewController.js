...
************************************************************************ */qx.Class.define("qx.app.apiviewer.TabViewController",
{
  ...
  construct : function(widgetRegistry)
  {
    ...
    qx.app.apiviewer.TabViewController.instance = this;
  ...
  members :
  {
    ...
    {
      return this.__open(classNode, qx.app.apiviewer.ui.tabview.PackagePage, newTab);
    },

    openClass : function(classNode, newTab) {
      return this.__open(classNode, qx.app.apiviewer.ui.tabview.ClassPage, newTab);
    },
