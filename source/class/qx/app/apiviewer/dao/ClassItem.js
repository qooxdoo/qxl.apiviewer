 ...
 */
qx.Class.define("qx.app.apiviewer.dao.ClassItem",
{
  extend : qx.app.apiviewer.dao.Node,

  /**
   * @param classDocNode {Map} class documentation node
   * @param parentClass {qx.app.apiviewer.dao.Class} reference to the class this item belongs to
  ...
  members :
  {
     ...
     *
     * @return {qx.app.apiviewer.dao.Class} the class this item belongs to
     */
    getClass : function()
    {
      return this._class;
    ...
    {
      return this._meta.overriddenFrom ? qx.app.apiviewer.dao.Class.getClassByName(this._meta.overriddenFrom) : null;
    },
     ...
     *
     * @param ifaceNode {qx.app.apiviewer.dao.Class} interface to check for
     ...
     *
     * @return {qx.app.apiviewer.dao.Class} The interface this item is required by.
     */
