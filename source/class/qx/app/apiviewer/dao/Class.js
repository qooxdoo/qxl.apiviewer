 ...
 */
qx.Class.define("qx.app.apiviewer.dao.Class",
{
  extend : qx.app.apiviewer.dao.Node,
  ...
  construct : function(className)
  {
    ...
    this._package = qx.app.apiviewer.dao.Package.getParentPackage(className);
  ...
  members : {
    ...
    load: function() {
      ...
      var url = qx.app.apiviewer.ClassLoader.getBaseUri() + "/transpiled/" + this._className.replace(/\./g, '/') + ".json";
      return this._loadingPromise = qx.app.apiviewer.RequestUtil.get(url)
        .then(content => {
    ...
    _initMeta: function(meta) {
      ...
      this._construct = meta.construct ? [ new qx.app.apiviewer.dao.Method(meta.construct, this, "construct") ] : [];
      this._destruct = meta.destruct ? [ new qx.app.apiviewer.dao.Method(meta.destruct, this, "destruct") ] : [];
      this._defer = meta.defer ? [ new qx.app.apiviewer.dao.Method(meta.defer, this, "defer") ] : [];
      ...
      if (meta.statics) {
        for (let name in meta.statics) {
          ...
          if (data.type == "variable") {
            this._constants.push(new qx.app.apiviewer.dao.Constant(data, this, name));
          } else {
            this._staticMethods.push(new qx.app.apiviewer.dao.Method(data, this, name));
          }
        }
      }
      ...
      if (meta.members) {
        for (let name in meta.members) {
          ...
          if (data.type == "function") {
            let obj = new qx.app.apiviewer.dao.Method(data, this, name);
            if (data.mixin)
      ...
      if (meta.properties) {
        for (let name in meta.properties) {
          ...
          let obj = new qx.app.apiviewer.dao.Property(data, this, name);
          if (data.mixin)
      ...
      if (meta.events) {
        for (let name in meta.events) {
          ...
          let obj = new qx.app.apiviewer.dao.Event(data, this);
          if (data.mixin)
      ...
      if (arr) {
        arr.forEach(elem => {
          this._childControls.push(new qx.app.apiviewer.dao.ChildControl(elem, this));
        });
      }
      
      var all = [];
      function findClasses(tmp) {
        return qx.app.apiviewer.dao.Class.findClasses(tmp).forEach(item => all.push(item));
      }
     ...
     * 
     * @return {qx.app.apiviewer.dao.Class} The super class of the class.
     */
     ...
     * 
     * @return {qx.Promise(qx.app.apiviewer.dao.Class[])} A list of direct child classes of the
     *         class.
     */
    getChildClasses : function() {
      if (!this._childClassesPromise) {
        if (this._meta.type == "class")
          this._childClassesPromise = qx.app.apiviewer.dao.Class.findClasses(this._meta.descendants);
        else
     ...
     * 
     * @return {qx.app.apiviewer.dao.Class[]} All interfaces declared at the class
     *         declaration.
     */
     ...
     * 
     * @return {qx.app.apiviewer.dao.Class[]} All super interfaces.
     */
     ...
     * 
     * @return {qx.app.apiviewer.dao.Class[]} All mixins declared at the class
     *         declaration.
     */
    getMixins : function() {
      return this._mixins; 
     ...
     * 
     * @return {qx.app.apiviewer.dao.Class[]} All super mixins.
     */
     ...
     * 
     * @return {qx.Promise(qx.app.apiviewer.dao.Class[])} All classes including this mixin.
     */
    getIncluder : function() {
      if (!this._includersPromise) {
        if (this._meta.type == "mixin")
          this._includersPromise = qx.app.apiviewer.dao.Class.findClasses(this._meta.descendants);
        else
     ...
     * 
     * @return {qx.Promise(qx.app.apiviewer.dao.Class[])} All implementations of this interface.
     */
    getImplementations : function() {
      if (!this._implementationsPromise) {
        if (this._meta.type == "interface")
          this._implementationsPromise = qx.app.apiviewer.dao.Class.findClasses(this._meta.descendants);
        else
     ...
     * 
     * @return {qx.app.apiviewer.dao.Method} The constructor of the class.
     */
     ...
     * 
     * @return {qx.app.apiviewer.dao.ChildControl[]} All child controls.
     */
     ...
     * 
     * @return {qx.app.apiviewer.dao.Method[]} The members of the class.
     ...
     * 
     * @return {qx.app.apiviewer.dao.Method[]} The statics of the class.
     */
    getStatics : function() {
     ...
     * 
     * @return {qx.app.apiviewer.dao.Event[]} The events of the class.
     */
    getEvents : function() {
      return this._events;
    },
     ...
     * 
     * @return {qx.app.apiviewer.dao.Property[]} The properties of the class.
     */
     ...
     * 
     * @return {qx.app.apiviewer.dao.Property} The named property
     */
     ...
     * 
     * @return {qx.app.apiviewer.dao.Constant[]} The constants of the class.
     */
     ...
     * @return {qx.app.apiviewer.dao.Class[]} array of super classes of the given
     *         class.
     */
    getClassHierarchy : function(includeNativeObjects) {
      ...
      for (var currentClass = this; currentClass; currentClass = currentClass.getSuperClass()) {
        var isNative = qx.app.apiviewer.dao.Class.isNativeObject(currentClass);
     ...
     * 
     * @return {qx.app.apiviewer.dao.Class[]} array of super interfaces of the given
     *         interface.
     */
     ...
     * @return {qx.app.apiviewer.dao.ClassItem} the class item.
     */
    ...
    loadDependedClasses: function() {
      return qx.app.apiviewer.ClassLoader.loadClassList(this.getDependedClasses());
    },
    ...
    getDependedClasses : function() {
      ...
      function findClasses(clazz) {
        if (qx.app.apiviewer.dao.Class.isNativeObject(clazz)) {
          return;
        }
  ...
  statics : {
     ...
     * @return {qx.app.apiviewer.dao.Class} The class documentation
     */
    getClassByName : function(className, create) {
      var nativeClass = qx.app.apiviewer.dao.Class._native_classes[className];
      if (nativeClass !== undefined)
        return nativeClass;
      
      var pkg = qx.app.apiviewer.dao.Package.getParentPackage(className);
      if (!pkg) {
      ...
      if (!cls && create) {
        cls = new qx.app.apiviewer.dao.Class(className);
      }
      return cls;
    },
    ...
    getClassesByName : function(classNames, create) {
      ...
      var result = classNames.map(name => qx.app.apiviewer.dao.Class.getClassByName(name, create));
      return result;
    },
    ...
    findClasses: function(name) {
      ...
      var all = qx.lang.Array.toNativeArray(name)
        .filter(name => !qx.app.apiviewer.dao.Class._native_classes[name])
        .map(name => qx.app.apiviewer.dao.Class.getClassByName(name).load());
      return qx.Promise.all(all);
    },
    
    
    /**
     * Checks if the Class is a qooxdoo qx.app.apiviewer.dao.Class Object or a native
     * one
     * 
     * @param clazz
     *          {qx.app.apiviewer.dao.Class} the object to be checked
     * @return {Boolean} true if it is a JS native object
     */
    isNativeObject : function(clazz){
      return "qx.app.apiviewer.dao.Class" !== clazz.classname;
    }
