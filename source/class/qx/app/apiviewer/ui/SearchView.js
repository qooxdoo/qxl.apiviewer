 ...
 */
qx.Class.define("qx.app.apiviewer.ui.SearchView",
{
  ...
  members :
  {
    ...
    _showSearchForm : function()
    {
      ...
      for(var i=0; i<types.length; i++)
      {
        ...
        var typeToggleButton = new qx.ui.form.ToggleButton("", "qx/app/apiviewer/image/"+iconNamePart+"18.gif");
              ...
              if(namespaceRegexp && namespaceRegexp.test(fullname)) {
                if (new RegExp(spath, "i").test(fullname)) {
                  ...
                  if(this._isTypeFilteredIn(elemtype)){
                    var icon = qx.app.apiviewer.TreeUtil["ICON_" + elemtype];
            ...
            for (var i=0, l=index[key].length; i<l; i++) {
              ...
              if(this._isTypeFilteredIn(elemtype)){
                if(namespaceRegexp && namespaceRegexp.test(fullname)) {
                  ...
                  if (elemtype == "CLASS") {
                    icon = qx.app.apiviewer.TreeUtil.getIconUrl(qx.app.apiviewer.dao.Class.getClassByName(fullname));
                  } else {
                    ...
                    icon = qx.app.apiviewer.TreeUtil["ICON_" + elemtype];
                  }
