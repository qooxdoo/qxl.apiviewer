...
qx.Class.define("qx.app.apiviewer.ui.panels.AbstractMethodPanel",
{
  ...
  members : {
     ...
     *
     * @param method {qx.app.apiviewer.dao.Method} The method doc node.
    ...
    getItemTitleHtml : function(method)
    {
      ...
      var titleHtml = new qx.util.StringBuilder(qx.app.apiviewer.ui.panels.InfoPanel.setTitleClass(method, title));
      ...
      for (var i=0; i<params.length; i++)
      {
        ...
        titleHtml.add(
          '<span class="parameter-type">', qx.app.apiviewer.ui.panels.InfoPanel.createTypeHtml(param, "var"),
    ...
    getItemTypeHtml : function(method)
    {
      ...
      if (!method.isConstructor()) {
        typeHtml.add(qx.app.apiviewer.ui.panels.InfoPanel.createTypeHtml(method.getReturn(), "void"));
      }
     ...
     *
     * @param method {qx.app.apiviewer.dao.Method} the doc node of the method.
     * @param currentClassDocNode {qx.app.apiviewer.dao.Class} the doc node of the currently displayed class
    ...
    getItemTextHtml : function(method, currentClassDocNode, showDetails)
    {
      ...
      if (method.isConstructor() && !method.getDescription()) {
        ...
        textHtml.add(qx.app.apiviewer.ui.panels.InfoPanel.createDescriptionHtml(method, docClass, showDetails));
      }
      ...
      if (showDetails)
      {
        ...
        if (params.length > 0)
        {
          ...
          for (var i=0; i<params.length; i++)
          {
            ...
            if (desc) {
              textHtml.add(" ", qx.app.apiviewer.ui.panels.InfoPanel.resolveLinkAttributes(desc, docClass));
            }
        ...
        if (returnNode)
        {
          ...
          if (desc) {
            textHtml.add(
              ...
              qx.app.apiviewer.ui.panels.InfoPanel.resolveLinkAttributes(desc, docClass),
              '</div>'
            );
          }
        }
        ...
        if (applyToProperties && applyToProperties.length>0) { // gabi check
          textHtml.add(
            ...
            for(var i=0;i<applyToProperties.length;i++){
              textHtml.add(qx.app.apiviewer.ui.panels.InfoPanel.createItemLinkHtml(
        ...
        if (throwsEntries.length > 0)
        {
          ...
          for (var i=0; i<throwsEntries.length; i++)
          {
            ...
            textHtml.add(
              ...
              throwsEntryType === throwsEntry.getDefaultType() ? throwsEntry.getDefaultType() : qx.app.apiviewer.ui.panels.InfoPanel.createItemLinkHtml(throwsEntryType),
              '</span>'
            );
        ...
        textHtml.add(qx.app.apiviewer.ui.panels.InfoPanel.createAccessHtml(method));
        textHtml.add(qx.app.apiviewer.ui.panels.InfoPanel.createIncludedFromHtml(method, currentClassDocNode));
        textHtml.add(qx.app.apiviewer.ui.panels.InfoPanel.createOverwriddenFromHtml(method));
        textHtml.add(qx.app.apiviewer.ui.panels.InfoPanel.createInheritedFromHtml(method, currentClassDocNode));
        textHtml.add(qx.app.apiviewer.ui.panels.InfoPanel.createInfoRequiredByHtml(method));
        textHtml.add(qx.app.apiviewer.ui.panels.InfoPanel.createSeeAlsoHtml(method));
        textHtml.add(qx.app.apiviewer.ui.panels.InfoPanel.createErrorHtml(method, currentClassDocNode));
        textHtml.add(qx.app.apiviewer.ui.panels.InfoPanel.createDeprecationHtml(method, "function"));
        textHtml.add(qx.app.apiviewer.ui.panels.InfoPanel.createSourceLinkHtml(method));
      }
    ...
    itemHasDetails : function(node, currentClassDocNode)
    {
      ...
      return (
        ...
        qx.app.apiviewer.ui.ClassViewer.getSourceUri(node)
      );
    }
