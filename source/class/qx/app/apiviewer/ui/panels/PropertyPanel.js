...
qx.Class.define("qx.app.apiviewer.ui.panels.PropertyPanel", {

  extend: qx.app.apiviewer.ui.panels.InfoPanel,

  construct: function() {
    this.base(arguments, "Properties", "qx/app/apiviewer/image/property18.gif");
  },
  ...
  members :
  {
    ...
    canDisplayItem: function(dao) {
      return dao instanceof qx.app.apiviewer.dao.Property; 
    },
    ...
    __createGeneratedMethodsHtml : function(node, currentClassDocNode)
    {
      ...
      return qx.app.apiviewer.ui.panels.InfoPanel.resolveLinkAttributes(textHtml.get(), currentClassDocNode);
    },
     ...
     *
     * @param node {qx.app.apiviewer.dao.ClassItem} item to get the the information from
    ...
    __createRefinedFromHtml : function(node)
    {
      if (node.isRefined())
      {
        var html = new qx.util.StringBuilder(
          ...
          qx.app.apiviewer.ui.panels.InfoPanel.createItemLinkHtml(node.getOverriddenFrom().getFullName()+"#"+node.getName()),
          '</div>'
        );
        return html.get();
      }
      ...
      if (showDetails)
      {
        ...
        if (node.getEvent() && !node.isRefined())
        {
          textHtml.add(
            ...
            '<div class="item-detail-text">',
            qx.app.apiviewer.ui.panels.InfoPanel.createItemLinkHtml(
        ...
        textHtml.add(qx.app.apiviewer.ui.panels.InfoPanel.createIncludedFromHtml(node, currentClassDocNode));
        ...
        textHtml.add(qx.app.apiviewer.ui.panels.InfoPanel.createInfoRequiredByHtml(node));
        ...
        textHtml.add(qx.app.apiviewer.ui.panels.InfoPanel.createDeprecationHtml(node, "property"));
      }
