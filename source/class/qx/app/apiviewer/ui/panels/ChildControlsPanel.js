...
qx.Class.define("qx.app.apiviewer.ui.panels.ChildControlsPanel", {

  extend: qx.app.apiviewer.ui.panels.InfoPanel,

  construct: function() {
    this.base(arguments, "Child Controls", "qx/app/apiviewer/image/childcontrol18.gif");
  },
  ...
  members :
  {
    ...
    canDisplayItem: function(dao) {
      return dao instanceof qx.app.apiviewer.dao.ChildControl; 
    },
    ...
    getItemTypeHtml : function(node, currentClassDocNode) {
      return qx.app.apiviewer.ui.panels.InfoPanel.createTypeHtml(node, "var", true);
    },
