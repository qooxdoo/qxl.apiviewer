...
************************************************************************ */
qx.Class.define("qx.app.apiviewer.ui.panels.ConstantPanel", {

  extend: qx.app.apiviewer.ui.panels.InfoPanel,

  construct: function() {
    this.base(arguments, "Constants", "qx/app/apiviewer/image/constant18.gif");
  },
  ...
  members : {
    ...
    canDisplayItem: function(dao) {
      return dao instanceof qx.app.apiviewer.dao.Constant; 
    },
    ...
    getItemTextHtml : function(node, currentClassDocNode, showDetails)
    {
      ...
      var textHtml = qx.app.apiviewer.ui.panels.InfoPanel.createDescriptionHtml(node, node.getClass(), showDetails);

      if (showDetails)
      {
        textHtml += this.__createConstantValueHtml(node);
        textHtml += qx.app.apiviewer.ui.panels.InfoPanel.createSeeAlsoHtml(node);
        textHtml += qx.app.apiviewer.ui.panels.InfoPanel.createErrorHtml(node, currentClassDocNode);
        textHtml += qx.app.apiviewer.ui.panels.InfoPanel.createDeprecationHtml(node, "constant");
      }
