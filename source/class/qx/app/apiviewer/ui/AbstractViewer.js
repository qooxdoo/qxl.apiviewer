...
qx.Class.define("qx.app.apiviewer.ui.AbstractViewer",
{
  type : "abstract",
  ...
  members :
  {
    ...
    _syncHtml : function()
    {
      ...
      qx.app.apiviewer.ui.AbstractViewer.fixLinks(element);
    ...
    _updatePanels : function()
    {
      ...
      return qx.Promise.all(all)
        .then(() => qx.app.apiviewer.LoadingIndicator.getInstance().hide());
    },
     ...
     *
     * @param classNode {qx.app.apiviewer.dao.Class} the doc node of the class to show.
     */
    _applyDocNode : function(classNode)
    {
      ...
      return this._getDescriptionHtml(classNode)
        .then(html => {
          ...
          qx.app.apiviewer.ui.AbstractViewer.fixLinks(this._classDescElem);
          qx.app.apiviewer.ui.AbstractViewer.highlightCode(this._classDescElem);
    ...
    togglePanelVisibility : function(panel)
    {
      try
      {
        ...
        imgElem.src = qx.util.ResourceManager.getInstance().toUri(panel.getIsOpen() ? 'qx/app/apiviewer/image/close.gif' : 'qx/app/apiviewer/image/open.gif');
     ...
     *
     * @param nodeArr {qx.app.apiviewer.dao.ClassItem[]} array of class items
     */
    sortItems : function(nodeArr) {
      
      let WEIGHT = [ "qx.app.apiviewer.dao.Package", "qx.app.apiviewer.dao.Class" ];
      ...
      nodeArr.sort((obj1, obj2) => {
        ...
        if (obj1 instanceof qx.app.apiviewer.dao.Package) {
