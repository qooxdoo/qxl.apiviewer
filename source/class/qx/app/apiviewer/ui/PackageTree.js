 ...
 * The package tree.
 */
qx.Class.define("qx.app.apiviewer.ui.PackageTree",
{
  ...
  members :
  {
     ...
     * 
     * @param docTree
     *          {qx.app.apiviewer.dao.Package} the documentation tree to use for
     *          updating.
     * @return {void}
     */
     ...
     * @param packageDoc
     *          {qx.app.apiviewer.dao.Package} the documentation node of the package.
     * @param depth
    ...
    {
      var PackageTree = qx.app.apiviewer.ui.PackageTree;
      ...
      packagesDoc.forEach(packageDoc => {
        var iconUrl = qx.app.apiviewer.TreeUtil.getIconUrl(packageDoc);
      ...
      treeNode.loading = docNode.loadDependedClasses().then(classes => {
        ...
        classes.forEach(classDoc => {
          var iconUrl = qx.app.apiviewer.TreeUtil.getIconUrl(classDoc);
