...
qx.Class.define("apiviewer.ui.ClassViewer",
{
  ...
  */
  ...
  {
    this.base(arguments);
    this.addInfoPanel(new apiviewer.ui.panels.ConstructorPanel("constructor"));
    this.addInfoPanel(new apiviewer.ui.panels.EventPanel("events", true, true));
    this.addInfoPanel(new apiviewer.ui.panels.StaticMethodsPanel("static methods"));
    this.addInfoPanel(new apiviewer.ui.panels.ConstantPanel("constants", false, true));
    this.addInfoPanel(new apiviewer.ui.panels.PropertyPanel("properties", true, true));
    this.addInfoPanel(new apiviewer.ui.panels.MethodPanel("methods"));
    this.addInfoPanel(new apiviewer.ui.panels.ChildControlsPanel("child controls"));
  ...
  members :
  {
    ...
    _getTocHtml : function(classNode)
    {
      ...
      this.getPanels().forEach(panel => {
        ...
        tocItem.innerHTML = apiviewer.ui.ClassViewer.createImageHtml(panel.getPanelIcon(), panel.getPanelTitle())+' ';
        ...
        if(panel instanceof apiviewer.ui.panels.StaticMethodsPanel && qx.core.Environment.get("engine.name") == 'webkit') {
