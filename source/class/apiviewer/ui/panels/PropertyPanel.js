...
qx.Class.define("apiviewer.ui.panels.PropertyPanel", {
  ...
  construct: function() {
    this.base(arguments, "Properties", "apiviewer/image/property18.gif");
  },
  ...
  members :
  {
    ...
    canDisplayItem: function(dao) {
      return dao instanceof apiviewer.dao.Property; 
    },
    ...
    getItemTextHtml : function(node, currentClassDocNode, showDetails)
    {
      ...
      if (showDetails)
      {
        ...
        textHtml.add(apiviewer.ui.panels.InfoPanel.createDeprecationHtml(node, "property"));
      }
