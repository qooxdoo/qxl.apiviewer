  ...
  qx.Class.define("qx.io.rest.Resource", {
    ...
    members: {
      ...
      map: function map(action, method, url, check) {
        ...
        this.__P_171_4(action, method, url, check);
       ...
       *   <code>qx.io.rest.Resource.REQUIRED</code> (to verify existence).
       */
      __P_171_4: function __P_171_4(action, method, url, check) {
        this.__P_171_2[action] = [method, url, check]; // Undefine generic getter when action is named "get"
        ...
        this.__P_171_5(action + "Success");

        this.__P_171_5(action + "Error");
      ...
      invoke: function invoke(action, params, data) {
        ...
        this.__P_171_2[action].params = params;
      ...
      poll: function poll(action, interval, params, immediately) {
        ...
        if (this.__P_171_1[action]) {
          this.__P_171_1[action].dispose();
        } // Fallback to previous params


        if (typeof params == "undefined") {
          params = this.__P_171_2[action].params;
        } // Invoke immediately
        ...
        var timer = this.__P_171_1[action] = new qx.event.Timer(interval);
      ...
      longPoll: function longPoll(action) {
        ...
        var handlerId = this.__P_171_0[action] = this.addListener(action + "Success", function longPollHandler() {
          if (res.isDisposed()) {
            return;
          }
       ...
       */
      __P_171_3: function __P_171_3(description) {
       ...
       */
      __P_171_5: function __P_171_5(type) {
    ...
    destruct: function destruct() {
      ...
      if (this.__P_171_1) {
        for (action in this.__P_171_1) {
          var timer = this.__P_171_1[action];
          timer.stop();
          timer.dispose();
        }
      }
      ...
      this._resource = this.__P_171_2 = this.__P_171_1 = this.__P_171_0 = null;
    }
  });
  qx.io.rest.Resource.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Resource.js.map?dt=1589989535974