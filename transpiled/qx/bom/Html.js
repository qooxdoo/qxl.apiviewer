  ...
  qx.Bootstrap.define("qx.bom.Html", {
    ...
    */
    statics: {
       ...
       */
      __P_19_0: function __P_19_0(all, front, tag) {
      ...
      fixEmptyTags: function fixEmptyTags(html) {
        return html.replace(/(<(\w+)[^>]*?)\/>/g, this.__P_19_0);
      },
       ...
       */
      __P_19_2: function __P_19_2(html, context) {
...
//# sourceMappingURL=Html.js.map?dt=1589975418066