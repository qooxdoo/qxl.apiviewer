  ...
  qx.Class.define("qx.bom.Shortcut", {
    ...
    */
    members: {
      ...
      */
       ...
       */
      __P_29_2: function __P_29_2(event) {
        if (this.getEnabled() && this.__P_29_3(event)) {
       ...
       * @param event {qx.event.type.KeySequence} The key event object
       */
      __P_29_4: function __P_29_4(event) {
        if (this.getEnabled() && this.__P_29_3(event)) {
          if (this.isAutoRepeat()) {
            this.execute(event.getTarget());
          }
      ...
      */
      ...
      _applyEnabled: function _applyEnabled(value, old) {
        if (value) {
          qx.event.Registration.addListener(document.documentElement, "keydown", this.__P_29_2, this);
          qx.event.Registration.addListener(document.documentElement, "keypress", this.__P_29_4, this);
        } else {
          qx.event.Registration.removeListener(document.documentElement, "keydown", this.__P_29_2, this);
          qx.event.Registration.removeListener(document.documentElement, "keypress", this.__P_29_4, this);
        }
      },
      // property apply
      _applyShortcut: function _applyShortcut(value, old) {
        if (value) {
          ...
          this.__P_29_1 = null; // To support shortcuts with "+" and "-" as keys it is necessary
          ...
          for (var i = 0; i < al; i++) {
            var identifier = this.__P_29_5(a[i]);
      ...
      */
       ...
       */
      __P_29_3: function __P_29_3(e) {
        var key = this.__P_29_1;
        ...
        if (!this.__P_29_0.Shift && e.isShiftPressed() || this.__P_29_0.Shift && !e.isShiftPressed() || !this.__P_29_0.Control && e.isCtrlPressed() || this.__P_29_0.Control && !e.isCtrlPressed() || !this.__P_29_0.Meta && e.isMetaPressed() || this.__P_29_0.Meta && !e.isMetaPressed() || !this.__P_29_0.Alt && e.isAltPressed() || this.__P_29_0.Alt && !e.isAltPressed()) {
          return false;
        }
      ...
      */
       ...
       */
      __P_29_5: function __P_29_5(keyName) {
        ...
        var keyIdentifier = this.__P_29_6[keyName] || qx.lang.String.firstUp(keyName);
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_29_0 = this.__P_29_1 = null;
    }
  });
  qx.bom.Shortcut.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Shortcut.js.map?dt=1589975419097