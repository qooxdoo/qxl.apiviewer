  ...
  qx.Bootstrap.define("qx.bom.storage.Memory", {
    statics: {
      ...
      getLocal: function getLocal() {
        ...
        return this.__P_65_0 = new qx.bom.storage.Memory();
      },
      ...
      getSession: function getSession() {
        if (this.__P_65_1) {
          return this.__P_65_1;
        }

        return this.__P_65_1 = new qx.bom.storage.Memory();
      }
    },
    ...
    members: {
      ...
      getLength: function getLength() {
        return Object.keys(this.__P_65_2).length;
      },
      ...
      getKey: function getKey(index) {
        var keys = Object.keys(this.__P_65_2);
        return keys[index];
      },
...
//# sourceMappingURL=Memory.js.map?dt=1590225826634