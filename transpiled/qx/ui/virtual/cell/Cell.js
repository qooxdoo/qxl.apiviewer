  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.cell.Cell", {
    ...
    construct: function construct() {
      ...
      this.__P_379_0 = qx.ui.virtual.cell.CellStylesheet.getInstance();
      this.__P_379_1 = {};
      this.__P_379_2 = {};
      this.__P_379_3 = {};
      this.__P_379_4 = {};
    ...
    */
    members: {
      ...
      _storeStyle: function _storeStyle(propertyName, styles) {
        ...
        if (this.__P_379_10) {
          store = this.__P_379_2;
        } else {
          store = this.__P_379_1;
        }
      ...
      _applyPadding: function _applyPadding(value, old, name) {
        ...
        if (this.__P_379_10) {
          var paddingStore = this.__P_379_4;
        } else {
          paddingStore = this.__P_379_3;
        }
      ...
      */
      ...
      getCssClasses: function getCssClasses(value, states) {
        var cssClass = this.__P_379_0.getCssClass(this.__P_379_9) || "";
       ...
       */
      __P_379_11: function __P_379_11(states) {
        ...
        if (this.__P_379_9 == statesKey) {
          return;
        }

        this.__P_379_9 = statesKey;
        var themeStyles = this.__P_379_5[this.__P_379_9];

        if (!themeStyles) {
          this.__P_379_12();

          this.__P_379_13(states);

          this.__P_379_14(states);

          this.__P_379_15();

          this.__P_379_5[this.__P_379_9] = 1;
        }
       ...
       */
      __P_379_12: function __P_379_12() {
        var PropertyUtil = qx.util.PropertyUtil;
       ...
       * @param states {Object} A map containing the cell's state names as map keys.
       */
      __P_379_13: function __P_379_13(states) {
        this.__P_379_2 = {};
        this.__P_379_10 = true;
        var appearance = this.getAppearance();
        var PropertyUtil = qx.util.PropertyUtil;
        ...
        this.__P_379_10 = false;
      },

      /**
       * Compute a CSS class for the current values of all CSS properties
       */
      __P_379_14: function __P_379_14() {
        var styleString = Object.values(this.__P_379_2).join(";");

        this.__P_379_0.computeClassForStyles(this.__P_379_9, styleString);
      },

      /**
       * Cache the themed values for the current state combination
       */
      __P_379_15: function __P_379_15() {
        var properties = this.__P_379_8;
        var PropertyUtil = qx.util.PropertyUtil;
        var themeValues = {};
        ...
        this.__P_379_6[this.__P_379_9] = themeValues;
      },

      /**
       * Apply the themed values to the properties
       */
      __P_379_16: function __P_379_16() {
        var PropertyUtil = qx.util.PropertyUtil;
        var themeValues = this.__P_379_6[this.__P_379_9] || {};
      ...
      getStyles: function getStyles(value, states) {
        return Object.values(this.__P_379_1).join(";");
      },
      // overridden
      getInsets: function getInsets(value, states) {
        var user = this.__P_379_3;
        var theme = this.__P_379_4;
    ...
    destruct: function destruct() {
      this.__P_379_0 = this.__P_379_1 = this.__P_379_2 = this.__P_379_3 = this.__P_379_4 = this.__P_379_5 = this.__P_379_6 = this.__P_379_8 = null;
    }
  });
  qx.ui.virtual.cell.Cell.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Cell.js.map?dt=1592642681364