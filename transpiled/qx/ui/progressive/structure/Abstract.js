  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.progressive.structure.Abstract", {
    ...
    construct: function construct(pane) {
      ...
      if (!pane) {
        this.__P_332_0 = new qx.ui.core.Widget();
        this.__P_332_1 = this.__P_332_0;
      } else {
        this.__P_332_0 = null;
        this.__P_332_1 = pane;
      }

      this.__P_332_1.getContentElement().setStyle("overflowY", "auto");
    },
    members: {
      __P_332_0: null,
      __P_332_1: null,
    ...
    destruct: function destruct() {
      ...
      this.__P_332_0 = this.__P_332_1 = null;
    }
  });
  qx.ui.progressive.structure.Abstract.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Abstract.js.map?dt=1590155929543