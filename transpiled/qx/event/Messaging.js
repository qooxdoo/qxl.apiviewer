  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.event.Messaging", {
    construct: function construct() {
      this._listener = {}, this.__P_118_0 = 0;
      this.__P_118_1 = {};
    },
    members: {
      _listener: null,
      ...
      remove: function remove(id) {
        var channel = this.__P_118_1[id];
        var listener = this._listener[channel];
        delete listener[id];
        delete this.__P_118_1[id];
      },
...
//# sourceMappingURL=Messaging.js.map?dt=1592642652672