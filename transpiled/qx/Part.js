  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.Part", {
    ...
    construct: function construct(loader) {
      ...
      this.__P_7_0 = loader; // initialize the pseudo event listener maps

      this.__P_7_1 = {};
      this.__P_7_2 = {};
      this.__P_7_3 = {}; // create the packages

      this.__P_7_4 = {};

      for (var key in loader.packages) {
        var pkg = new qx.io.part.Package(this.__P_7_5(loader.packages[key].uris), key, key == bootPackageKey);
        this.__P_7_4[key] = pkg;
      }
      ...
      for (var name in parts) {
        ...
        for (var i = 0; i < pkgKeys.length; i++) {
          packages.push(this.__P_7_4[pkgKeys[i]]);
    ...
    members: {
      ...
      saveClosure: function saveClosure(id, closure) {
        ...
        var pkg = this.__P_7_4[id]; // error if no package could be found
      ...
      require: function require(partNames, callback, self) {
        ...
        for (var i = 0; i < partNames.length; i++) {
          var part = this.__P_7_6[partNames[i]];
      ...
      preload: function preload(partNames, callback, self) {
        ...
        for (var i = 0; i < partNames.length; i++) {
          this.__P_7_6[partNames[i]].preload(function () {
            partsPreloaded++;
            ...
            if (partsPreloaded >= partNames.length) {
              ...
              for (var i = 0; i < partNames.length; i++) {
                states.push(this.__P_7_6[partNames[i]].getReadyState());
              }
      ...
      __P_7_7: function __P_7_7() {
        var packages = this.__P_7_0.packages;
        var uris = [];

        for (var key in packages) {
          uris.push(this.__P_7_5(packages[key].uris));
        }
      ...
      */
      ...
      addPartListener: function addPartListener(part, callback) {
        ...
        this.__P_7_1[key].push(callback);
      },
      ...
      notifyPartResult: function notifyPartResult(part) {
        var key = part.getName();
        var listeners = this.__P_7_1[key];
      ...
      */
      ...
      addPackageListener: function addPackageListener(pkg, callback) {
        ...
        this.__P_7_2[key].push(callback);
      },
      ...
      notifyPackageResult: function notifyPackageResult(pkg) {
        var key = pkg.getId();
        var listeners = this.__P_7_2[key];
...
//# sourceMappingURL=Part.js.map?dt=1589813316332