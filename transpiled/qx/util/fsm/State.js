  ...
  qx.Class.define("qx.util.fsm.State", {
    ...
    construct: function construct(stateName, stateInfo) {
      ...
      for (var field in stateInfo) {
        ...
        switch (field) {
          case "onentry":
            this.setOnentry(this.__P_422_0(stateInfo[field], context));
            break;

          case "onexit":
            this.setOnexit(this.__P_422_0(stateInfo[field], context));
            break;
    ...
    members: {
       ...
       */
      __P_422_1: function __P_422_1(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_422_2: function __P_422_2(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_422_3: function __P_422_3(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_422_8: function __P_422_8(value) {
       ...
       * @return {var} the final value
       */
      __P_422_4: function __P_422_4(value) {
       ...
       * @return {var} the final value
       */
      __P_422_5: function __P_422_5(value) {
       ...
       * @return {var} the final value
       */
      __P_422_6: function __P_422_6(value) {
       ...
       * @return {var} the final value
       */
      __P_422_7: function __P_422_7(value) {
       ...
       *   unaltered.
       */
      __P_422_0: function __P_422_0(f, context) {
...
//# sourceMappingURL=State.js.map?dt=1592642685828