  ...
  qx.Class.define("qxl.apiviewer.ui.SearchView", {
    ...
    members: {
      ...
      search: function search(term) {
        ...
        if (qx.lang.Object.getLength(this.apiindex) == 0) {
          ...
          this.__P_431_5 = null; // Set search box value
      ...
      _showSearchForm: function _showSearchForm() {
        ...
        this.__P_431_3 = new qx.data.Array([true, true, true, true, true, true, true]);
        ...
        for (var i = 0; i < types.length; i++) {
          ...
          typeToggleButton.bind("value", this.__P_431_3, "[" + i + "]");
          ...
          this.__P_431_3.bind("[" + i + "]", typeToggleButton, "value");
        }
        ...
        typeToggleButtonAll.addListener("changeValue", function (e) {
          for (var i = 0; i < this.__P_431_3.length; i++) {
            this.__P_431_3.setItem(i, e.getData());
          }
        ...
        this.__P_431_0 = true;
        this.__P_431_2 = table; // table.addListener("appear", this.__handleNote, this);
      ...
      _searchResult: function _searchResult(svalue) {
        ...
        for (var i = 0; i < this.__P_431_3.length; i++) {
          if (this.__P_431_3.getItem(i) === true) {
      ...
      _searchIndex: function _searchIndex(svalue, spath) {
        ...
        var index = this.apiindex.__P_431_6;
        var fullNames = this.apiindex.__P_431_7;
        var types = this.apiindex.__P_431_8;
      ...
      _isTypeFilteredIn: function _isTypeFilteredIn(type) {
        return this.__P_431_3.getItem(this.__P_431_4[type]);
      },
      ...
      _load: function _load() {
        ...
        req.addListener("completed", function (evt) {
          ...
          if (this.__P_431_5) {
            setTimeout(function () {
              this.sinput.setValue(this.__P_431_5);
              this.__P_431_5 = null;
            }.bind(this), 0);
          }
        }, this);
      ...
      __P_431_9: function __P_431_9(table) {
        this.__P_431_1 = new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({
          autoHide: false,
          width: 170
        });
        ...
        this.__P_431_1.add(hint, {
          edge: 3
        });

        this.__P_431_1.setPosition("bottom-left");

        this.__P_431_1.placeToWidget(this.sinput, false);

        this.__P_431_1.show();
      },
      __P_431_10: function __P_431_10(e) {
        if (this.__P_431_1) {
    ...
    */
    destruct: function destruct() {
      this.apiindex = this._table = this.__P_431_2 = this._tableModel = this.__P_431_3 = this.__P_431_4 = this._selectionModel = null;

      this._disposeObjects("sinput", "__P_431_1");
...
//# sourceMappingURL=SearchView.js.map?dt=1589813352365